...
export default function Gallery() {
    return (
        ...
        <div className="py-[48px] px-[16px] lg:p-[80px] bg-[#0F172A] w-[1,440px] flex flex-col gap-[80px] ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[48px] ">
                ...
                {/*<div  className='z-30 absolute top-[193px] left-[60px] bottom-[56px] right-[33px]  border-8 border-amber-50'>*/}
                {/*    <Image*/}
                {/*        className={''}*/}
                {/*        src={'/images/Backlights.svg'} alt={"Back lights"} layout={'fill'}/>*/}
                {/*</div>*/}


                {/*<Image className=' absolute top-[176px] left-[-35px]' src={'/images/figuras/Rectangle Rosa.svg'} alt={"Back lights"} width={271} height={271} />*/}
                {/*<Image className=' absolute top-[-31px] left-[422px]' src={'/images/figuras/Rectangle azul.svg'} alt={"Back lights"} width={161} height={161} />*/}
                {/*<Image className=' absolute top-[294px] left-[721px]' src={'/images/figuras/Rectangle naranja.svg'} alt={"Back lights"} width={130} height={130} />*/}
                {/*<Image className=' absolute top-[294px] left-[721px]' src={'/images/figuras/Rectangle fucsia.svg'} alt={"Back lights"} width={130} height={130} />*/}
                {/*<Image className=' absolute top-[294px] left-[982px]' src={'/images/figuras/Rectangle verde.svg'} alt={"Back lights"} width={202} height={202} />*/}
            </div>
